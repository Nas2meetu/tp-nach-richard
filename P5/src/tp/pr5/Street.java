 ...
 * @version 5
 * 
 *          A street links two places A and B in one direction. If it is defined
 *          as Street(A,NORTH,B) it means that Place B is at NORTH of Place A.
 *          Streets are two-way streets, i.e. if B is at NORTH of A then A is at
 *          SOUTH of B.
 * 
 *          Some streets are closed and a code (contained in a code card) is
 *          needed to open them
 */
...
public class Street {
	 ...
	 * 
	 * @param sourcePlace
	 *            is one side of street.
	 * @param direction
	 *            is default direction.
	 * @param targetPlace
	 *            is opposite side of street.
	 */
	 ...
	 *            is opposite side of street.
	 * @param Open
	 *            is default street situation.
	 * @param code
	 *            is default code.
	 */

	public Street(Place sourcePlace, Direction direction, Place targetPlace,
			boolean Open, String code) {
		this.sourcePlace = sourcePlace;
		this.direction = direction;
		this.targetPlace = targetPlace;
		this.isOpen = Open;
	 ...
	 * 
	 * @param place
	 *            is place where Robot is --o esta o la del nextplace--
	 * @param fromDirection
	 *            is direction where Robot comes
	 * @return ComeOutFrom is correct place that Robot moves
	 */

	public boolean comeOutFrom(Place place, Direction fromDirection) {

		return ((comeOutFromSourcePlace(place, fromDirection) || comeOutFromTargetPlace(
				place, fromDirection)));
	 ...
	 * 
	 * @param card
	 *            is a CodeCard of Wall·E container.
	...
	/**
	 * If isOpen is true and CodeCard of Wall·E container is equal than code of
	 * street return false, because street is open not close.
	 * 
	 * @param card
	 *            is a CodeCard of Wall·E container.
